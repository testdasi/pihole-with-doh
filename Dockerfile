...
RUN cd /tmp \
    ...
    && echo '/usr/local/bin/cloudflared proxy-dns --port 5053 --upstream https://1.1.1.1/dns-query --upstream https://dns.google/dns-query --upstream https://1.0.0.1/dns-query' >> /etc/services.d/cloudflared/run \
